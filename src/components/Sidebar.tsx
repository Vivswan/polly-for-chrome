	...
	return (
		<div className="flex flex-col w-56 p-2 py-2.5 border-r">
			<div className="flex items-center text-center mb-3 mx-1 ml-3">
				...
				<div>
					<div className="text-base font-bold text-neutral-800 bg-">{t("app.name")}</div>
			...
			<div className="mt-auto">
				...
				<Sidebar.Item Icon={GitHub} color="bg-neutral-600" to="https://github.com/vivswan/polly-for-chrome">
